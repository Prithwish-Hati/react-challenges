    ...
    return (
        <section className='my-8'>
            ...
            <div className='mt-6 flex'>
                <button onClick={handleDecrement} className='border-2 border-my-blue p-2'>
                    <CircleMinus />
                </button>
                <span className='text-3xl border-y-2 border-my-blue px-2 font-normal'>{count}</span>
                <button onClick={handleIncrement} className='border-2 border-my-blue p-2'>
                    <CirclePlus />
                </button>
            </div>
