...
const DynamicList = () => {
    ...
    return (
        <section className='my-8'>
            ...
            <input type='text' className='border-2 border-my-blue mt-6 w-4/12' ref={myInput} />
            <button className='ml-4 border-2 border-my-blue shadow-mini px-2' onClick={handleAdd}>Add</button>
            <button className='ml-4 border-2 border-my-blue shadow-mini px-2' onClick={handleClear}>Clear</button>
            {listItems.length > 0 &&
